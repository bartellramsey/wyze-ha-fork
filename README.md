...
This is a direct fork of [kevinvincent's](https://github.com/kevinvincent/ha-wyzesense) code with a single small patch (credit: [u/droans](https://reddit.com/u/droans)) to keep it going (as of April 2021).
My goal is simply to compile and merge patches as I find them to keep this component alive as long as possible. If Kevin returns this project will cease.
